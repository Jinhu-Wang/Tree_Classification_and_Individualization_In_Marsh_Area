...
// Local
#include <trees3d/tree_classification/export.h>

namespace fs = std::filesystem;

namespace resource
{
    // static std::string resource_dir = convert_to_unix_style(Trees3D_RESOURCE_DIR);

    std::fs::path genericPath = Trees3D_RESOURCE_DIR;

    static std::string resource_dir = genericPath.string();
    ...
    void initialize(const std::string &resource_dir = Trees3D_RESOURCE_DIR)
    {
        ...
        resource_dir = genericPath.string();
    }
